    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-1">Modifica il tuo album</h1>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-7">
                ...
                <form method="POST" action="{{route('album.update', compact('album'))}}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
